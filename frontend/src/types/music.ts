...
/**
 * Provider availability info from backend
 */
export interface MusicProviderInfo {
  ...
  available: boolean
  models: MusicModel[]
  default_model: MusicModel
  capabilities: MusicGenerationType[]
...
export interface MusicState {
  ...
  providerAvailability: Record<MusicProvider, MusicProviderInfo> | null
...
/**
 * Provider configuration: models and capabilities per provider.
 * This is the single source of truth for provider-first selection logic.
 */
export const PROVIDER_CONFIG: Record<
  MusicProvider,
  {
    label: string
    models: MusicModel[]
    defaultModel: MusicModel
    capabilities: MusicGenerationType[]
  }
> = {
  mureka: {
    label: 'Mureka AI',
    models: ['auto', 'mureka-01', 'v7.5', 'v6'],
    defaultModel: 'auto',
    capabilities: ['instrumental', 'song', 'lyrics'],
  },
  lyria: {
    label: 'Google Lyria',
    models: ['lyria-002'],
