...
export type CascadeLLMProvider = 'openai' | 'anthropic' | 'gemini' | 'azure-openai' | 'xgrok'
export type CascadeTTSProvider = 'azure' | 'gcp' | 'elevenlabs' | 'gemini' | 'gemini-flash' | 'gemini-pro' | 'voai' | 'xgrok'
...
export type ChildAgeGroup = '2-4' | '5-7' | '8-12'
