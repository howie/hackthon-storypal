...
class GeneratedContentType(StrEnum):
    """Type of generated content attached to a story session."""
...
@dataclass
class ChildConfig:
    """Configuration describing the child for personalised story generation."""
...
class ImagePromptItem:
    """Transient dataclass for LLM-generated image prompt (not persisted)."""
...
class StorySession:
    ...
    child_config: ChildConfig = field(default_factory=ChildConfig)
...
@dataclass
class StoryGeneratedContent:
    """AI-generated content (song, Q&A, interactive choices) for a session."""
