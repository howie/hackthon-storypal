...
class BaseWebSocketHandler(ABC):
    ...
    def _mark_disconnected(self, context: str, exc: Exception) -> None:
        """Mark connection as closed and log the disconnection."""
        self._connected = False
        self._logger.info("Client disconnected during %s: %s", context, exc)

    async def _safe_send_json(self, payload: dict[str, Any]) -> bool:
        """Send raw JSON to client, return False if disconnected."""
        ...
        try:
            ...
            self._mark_disconnected("send_json", e)
            return False
    ...
    async def send_message(self, message: WebSocketMessage) -> None:
        ...
        try:
            ...
            self._mark_disconnected("send_message", e)
        except Exception as e:
    ...
    async def handle(self) -> None:
        ...
        try:
            ...
            self._mark_disconnected("handle", e)
        except Exception as e:
