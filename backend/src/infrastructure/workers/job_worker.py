...
class JobWorker:
    ...
    def __init__(
        ...
        storage_path: str | None = None,  # noqa: ARG002 — kept for backward compat; factory reads env
    ) -> None:
        """Initialize the job worker.

        Args:
            session_factory: SQLAlchemy async session factory
            storage_path: Ignored; storage backend is determined by ``AUDIO_BUCKET`` env var.
        """
